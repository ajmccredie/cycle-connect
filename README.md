...
This sprint was mostly focussed on identifying and solving any issues which were not found during earlier functional tests. Issues were deliberately generated by assessing unlikely, but possible user inputs in form fields. Identifying the user stories which had been assigned to work on later, but would not be possible in the time frame was difficult. These were moved into 'not in this project. 
