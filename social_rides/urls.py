...
from .views import RidesOverview, RideDetailView, AddRideView, RegisterForRide, RideEditView, RideDeleteView, RideCancelView, RideConfirmDeleteView, RideConfirmCancelView
from . import views
